...
class MemoryRecoveryStore {
  ...
  readonly artifacts: RecoveryArtifact[] = [
    ...
    { id: 'sealed-editorial-blueprint', attemptId: 'expired-attempt', kind: 'report_editorial_blueprint', state: 'SEALED', storageUri: '/runs/editorial-blueprint.json' },
    { id: 'sealed-standalone-html', attemptId: 'expired-attempt', kind: 'standalone_html_report', state: 'SEALED', storageUri: '/runs/report.html' },
    { id: 'sealed-showcase-spec', attemptId: 'expired-attempt', kind: 'report_editorial_showcase_spec', state: 'SEALED', storageUri: '/runs/editorial-showcase-spec.json' },
    { id: 'sealed-showcase-html', attemptId: 'expired-attempt', kind: 'editorial_showcase_html', state: 'SEALED', storageUri: '/runs/editorial-showcase.html' },
...
test('recover invalidates sealed terminal and unpublished step Artifacts but preserves referenced outputs', async () => {
  ...
  for (const id of [
    ...
    'sealed-review',
    'sealed-document',
    'sealed-editorial-blueprint',
    'sealed-standalone-html',
    'sealed-showcase-spec',
    'sealed-showcase-html',
    'sealed-package',
    'sealed-visual',
