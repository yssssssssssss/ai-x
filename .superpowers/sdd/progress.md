...
- Phase 3 final-gate blockers: complete; A–F/G clean cutover verified across offline execution, real PostgreSQL persistence/revision transactions, API/Web input boundaries, failed Skill provenance recovery, and direct execution regressions.
